...
class SimpleSplitText {
  ...
  constructor(element: HTMLElement, options: { charsClass?: string; wordsClass?: string }) {
...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const splitRef = useRef<SimpleSplitText | null>(null);
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        splitRef.current = new SimpleSplitText(el, {
